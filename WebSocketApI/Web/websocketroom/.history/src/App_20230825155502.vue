    ...
    <el-card class="box-card">
      ...
      <div style="padding: 14px">
        <div class="bottom">
          ...
          <el-input v-model="roomNo" />
          <el-input v-model="message" />
          <el-button text class="button" @click="send">发送</el-button>
          <el-button text class="button" @click="join">加入</el-button>
          <el-button text class="button" @click="leave">离开</el-button>
        </div>
      </div>
    </el-card>
  </div>
